...
// => x sẽ trả về các property (thuộc tính): name, price, brand, color
...
// Câu 2: (ES6 destructuring object - Cấu trúc đối tượng)

// Learn about destructuring object in the following tutorials:
...
// Câu 3: 
// Here is the actual data from a job search site, copy all of the data, assign it to a variable or a constant named jobSearch in your code. Log or print it out to see its structure then answer the following questions:
...
//jobSearch['hits'][0] => phần tử đầu tiên của mảng hits  
